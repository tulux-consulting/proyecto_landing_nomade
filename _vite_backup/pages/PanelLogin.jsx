// NÓMADE — Acceso interno (route "/panel/login").
// Puerta del backoffice. Si ya hay sesión, redirige al panel.
...
export default function PanelLogin() {
  ...
  useEffect(() => { if (panelIsAuthed()) navigate("/panel", { replace: true }); }, [navigate]);

  const submit = (e) => {
    e.preventDefault();
    if (panelLogin(user, pass)) {
